...
def test_get_flight_levels():
	...
	scn_data = {"scn_name": "test_get_flight_levels",
	            "content": [
		            "00:00:00> CRE AC0006 B744 0 0 0 FL250 250",
		            "00:00:00.1> ADDWPT AC0006,-1.84189483394,-0.118823382978,9500.0,351.123056728",
	...
	assert resp.json()[test_acid]['alt'] == 7620, 'Expected the initial flight level to be FL250'
	...
	resp = requests.post(f'{API_URL_BASE}/alt', json={'acid': test_acid, 'alt': 'FL150'})
	...
	assert resp.json()['fl_current'] == 7620, 'Expected the current flight level to be correct'
	assert resp.json()['fl_cleared'] == 4572, 'Expected the cleared flight level to be correct'
	assert resp.json()['fl_requested'] == 2896, 'Expected the requested flight level to be correct'
...
def test_initial_cleared_flight_level():
	...
	scn_data = {"scn_name": "test_cleared_flight_level",
	            "content": [
		            "00:00:00> CRE AC0006 B744 0 0 0 FL250 250",
		            "00:00:00.1> ADDWPT AC0006,-1.84189483394,-0.118823382978,9500.0,351.123056728",
		            "00:00:00.1> ADDWPT AC0006,-2.97563956062,-2.23988660389,,351.123056728",
	...
	assert resp.json()['fl_cleared'] == 7620, \
